...
namespace Adept_Tracker
{
    ...
    internal class JungleTracker
    {
        ...
        static JungleTracker()
        {
            ...
            JungleCamps = new List<JungleCamp>
            {
                ...
                new JungleCamp(
                    ...
                    new[]
                    {
                        "SRU_Razorbeak3.1.1", "SRU_RazorbeakMini3.1.2", "SRU_RazorbeakMini3.1.3",
                ...
                new JungleCamp(
                    ...
                    new[]
                    {
                        "SRU_Krug5.1.2", "SRU_KrugMini5.1.1", "SRU_KrugMini5.1.2", "SRU_KrugMini5.1.3",
                        "SRU_KrugMini5.1.4", "SRU_KrugMini5.1.5",
                ...
                new JungleCamp(
                    ...
                    new[]
                    {
                        "SRU_Krug11.1.2", "SRU_KrugMini11.1.1", "SRU_KrugMini11.1.2", "SRU_KrugMini11.1.3",
                        "SRU_KrugMini11.1.4", "SRU_KrugMini11.1.5",
                ...
                new JungleCamp(
                    ...
                    new[]
                    {
                        "SRU_Razorbeak9.1.1", "SRU_RazorbeakMini9.1.2", "SRU_RazorbeakMini9.1.3",
                ...
                new JungleCamp(
                    ...
                    new[]
                    {
                        "SRU_Dragon_Air6.1.1", "SRU_Dragon_Fire6.2.1", "SRU_Dragon_Water6.3.1", "SRU_Dragon_Earth6.4.1",
            ...
            // Gatta save that .5ms
            JungleCamps = JungleCamps.Where(x => x.MapType == Game.MapId).ToList();
        }
        ...
        {
            get { return JungleCamps.Where(x => x.Dead); }
        }
        ...
        private void OnDestroy(GameObject sender)
        {
            ...
            camp.Dead = true;
            camp.NextRespawnTime = Game.ClockTime + camp.RespawnTime / 1000f - 3;
        ...
        public class JungleCamp
        {
            ...
            ///     The type of the map.
            /// </value>
            public GameMapId MapType { get; set; }
            ...
            public Vector2 MinimapPosition
            {
                get
                {
                    Render.WorldToMinimap(Position, out var minimapPosition);
