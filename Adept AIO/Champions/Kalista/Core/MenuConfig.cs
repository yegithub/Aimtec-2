namespace Adept_AIO.Champions.Kalista.Core
{
    ...
    class MenuConfig
    {
        ...
        public MenuConfig()
        {
            ...
            {
                new MenuBool("Minions", "Auto Attack Minions"), new MenuBool("Kite", "Automatic Kiting", false), new MenuBool("Q", "Use Q"),
            ...
            {
                new MenuBool("Check", "Dont' Clear When Enemies Nearby"), new MenuSliderBool("Q", "Min. Q Hit", true, 3, 1, 7), new MenuBool("E", "Use E")
            };
            ...
            {
                new MenuBool("E", "Use E"), new MenuBool("Q", "Use Q")
            };

            Misc = new Menu("KalistaMisc", "Miscellaneous")
            {
                new MenuSliderBool("Soulbound", "Use R If Soulbound Health % <=", true, 10), new MenuBool("E", "Use E on minions when enemy has E stacks"), new MenuBool("W", "Use W Automatically")
            };

            Drawings = new Menu("KalistaDrawings", "Drawings")
            {
                new MenuSlider("Segments", "Segments", 100, 10, 150).SetToolTip("Smoothness of the circles"), new MenuBool("Dmg", "Damage"), new MenuBool("Debug", "Debug")
            };
