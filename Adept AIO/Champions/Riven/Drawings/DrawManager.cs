        ...
        public static void RenderBasics()
        {
            ...
            if (MenuConfig.FleeMode.Active && !Extensions.FleePos.IsZero)
            {
                ...
                if (!WallExtension.EndPoint.IsZero)
                {
                    ...
                    Render.Circle(WallExtension.EndPoint,
                        50,
            ...
            if (MenuConfig.Drawings["Mouse"].Enabled && Global.Orbwalker.Mode != OrbwalkingMode.None)
            {
                ...
                if (temp != null && temp.IsHero && temp.Distance(Global.Player) > Global.Player.AttackRange - 100)
                {
                    ...
                    Render.Text("Put Mouse Here",
                        new Vector2(posV2.X - 50, posV2.Y),
            ...
            if (MenuConfig.Drawings["Pattern"].Enabled)
            {
                ...
                if (MenuConfig.BurstMode.Active)
                {
                    ...
                    Render.Text("PATTERN: " + Enums.BurstPattern,
                        new Vector2(playerV2.X - 65, playerV2.Y + 30),
                        RenderTextFlags.Center,
                        Color.Aqua);
                }
                ...
                switch (Global.Orbwalker.Mode)
                {
                    case OrbwalkingMode.Combo:
                        RenderHelper.RenderArrowFromPlayer(
                            Global.TargetSelector.GetTarget(Extensions.EngageRange + 800));
                        Render.Text("PATTERN: " + Enums.ComboPattern,
                            new Vector2(playerV2.X - 65, playerV2.Y + 30),
                            RenderTextFlags.Center,
                            Color.Aqua);
                        break;
                    ...
                    case OrbwalkingMode.Mixed:
                        RenderHelper.RenderArrowFromPlayer(
                            Global.TargetSelector.GetTarget(Extensions.EngageRange + 800));
                        Render.Text("PATTERN: " + Enums.Current,
                            new Vector2(playerV2.X - 65, playerV2.Y + 30),
                            RenderTextFlags.Center,
                            Color.Aqua);
                        break;
