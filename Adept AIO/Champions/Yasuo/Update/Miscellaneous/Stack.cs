...
namespace Adept_AIO.Champions.Yasuo.Update.Miscellaneous
{
    class Stack
    {
        ...
        {
            if (Global.Player.CountEnemyHeroesInRange(600) >= 1 || Global.Player.CountEnemyHeroesInRange(2000) == 0 || Global.Orbwalker.IsWindingUp || Global.Player.IsDashing() || !MenuConfig.Misc["Stack"].Enabled || !SpellConfig.Q.Ready || Extension.CurrentMode != Mode.Normal)
            {
                return;
            }
