...
namespace Adept_AIO.Champions.LeeSin.Update.Miscellaneous
{
    ...
    internal class Killsteal : IKillsteal
    {
        ...
        public void OnUpdate()
        {
            ...
            if (SpellConfig.Q.Ready && (SpellConfig.IsQ2() ? target.Health < GlobalExtension.Player.GetSpellDamage(target, SpellSlot.Q, DamageStage.SecondCast) : target.Health < GlobalExtension.Player.GetSpellDamage(target, SpellSlot.Q)) &&
